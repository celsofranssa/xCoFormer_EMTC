...
from source.Dataset.XMTCRerankerDataset import XMTCRerankerDataset


class XMTCRerankerDataModule(pl.LightningDataModule):

    def __init__(self, params, tokenizer, fold):
        super(XMTCRerankerDataModule, self).__init__()
        self.params = params
    ...
    def setup(self, stage=None):
        ...
        if stage == 'fit':
            self.train_dataset = XMTCRerankerDataset(
            ...
            self.val_dataset = XMTCRerankerDataset(
                samples=self.samples,
                pseudo_labels=self.pseudo_labels,
